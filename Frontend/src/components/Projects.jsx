  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-5">
        <div className="absolute top-1/4 -left-10 w-72 h-72 bg-blue-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 text-sm">Projects will appear here once added from the admin panel.</p>
          </div>
        ) : (
            ...
            {projects.map((project) => (
              <div key={project._id} className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                ...
                <div className="p-6 text-center bg-gradient-to-b from-white to-gray-50">
                  ...
                  <button className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold py-2.5 px-8 rounded-lg transition-all duration-300 group">
