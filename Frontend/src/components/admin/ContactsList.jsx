    ...
    <div>
      {contacts.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-gray-400 text-sm mt-2">Contact submissions will appear here once users submit the form.</p>
        </div>
      ) : (
        <div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {contacts.map((contact, index) => (
                    <tr key={contact._id} className={`hover:bg-blue-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
